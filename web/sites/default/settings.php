...
// Migrate content from Drupal 7 website (need D7 database) :
/*
  drush migrate:import d7_breve
  drush migrate: import d7_actu
...
$settings['vite'] = [
  ...
  'useDevServer' => getenv('VITE_USE_DEV_SERVER') === "TRUE",
  // Global overrides.
   ...
   */
  // 'enabled' => TRUE,
  'baseUrl' => '/themes/custom/base_theme/dist/',
  'devServerUrl' => 'https://vite-3100.dbm-local.com',
  // 'overrides' => [
